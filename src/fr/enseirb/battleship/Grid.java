...
public class Grid {
	...
	public Grid() {	
		setGridElements();
		nbCellWidth = getWidth();
		nbCellHeight = getHeight();
		nbBattleship = getNbBattleship();
		nbAircraftCarrier = getNbAircraftCarrier();
		nbDestroyer = getNbDestroyer();
		nbPatrolBoat = getNbPatrolBoat();
		nbSubmarine = getNbSubmarine();
    ...
    public void setGridElements(){
    	...
    	String[] gridElements = xml.grid_maker();
    ...
    /* Create svg */
    /*--------------*/
    public void svgMaker (Writer w, Grid grid) throws InvalidGridException {
